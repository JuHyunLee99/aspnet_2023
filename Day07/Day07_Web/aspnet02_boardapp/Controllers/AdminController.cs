...
namespace aspnet02_boardapp.Controllers
{
    ...
    {
        private readonly RoleManager<IdentityRole> _roleManager;    // 역할에 대한 정보
        private readonly UserManager<IdentityUser> _userManager;    // 로그인이후 사용자에 대한 정보
        ...
        public async Task<IActionResult> EditUsersInRole(List<UserRoleModel> model, string roleId)
        {
            ...
            foreach (var user in model)
            {
                ...
                {
                    result = await _userManager.RemoveFromRoleAsync(userObj, role.Name);    // 사용자
                }
            }
